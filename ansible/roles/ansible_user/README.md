...
Перезагрузка сервера после установки sudo (если требовалось).<br>
Создание группы и пользователя с заданными параметрами.<br>
Настройка домашней директории и shell пользователя.<br>
Создание директории ~/.ssh и установка корректных прав.<br>
Копирование публичного SSH-ключа.<br>
Настройка правил в sudoers.<br>
